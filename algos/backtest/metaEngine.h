...
#define PV 9   // position volume
#define PT 10  // position time openned - needed by algos closing by time
#define PK 11 // position kind buy or sell
#define PC 12  // last time changed
// deals
#define DT 13  // deal time
#define DV 14  // deal volume
#define DR 15  // deal result + money back , - money taken or 0 nothing
#define DE 16  // deal entry - in (1) or out(0) or inout reverse (2)
...
#define Position_Kind_Buy 0
#define Position_Kind_Sell 1

#define N 17 // number of collumns

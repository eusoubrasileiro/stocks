...
parser.add_argument("-meta5", dest="meta5", default=False, action="store_false",
                    help="link all *.mql and *.mqh files to MetaTrader 5 Advisors Path")
parser.add_argument("-clean", dest="clean", default=False, action="store_false",
                    help="clean all symlinks")
parser.add_argument("-newdata", dest="newdata", default=False, action="store_false",
...
if args.clean:
    ...
    subprocess.call("find . -type l -exec unlink \{\} \;")
...
if args.meta5:
    ...
    subprocess.call("cd /home/andre/.wine/drive_c/Program Files/MetaTrader 5/MQL5/Experts/Advisors")
    subprocess.call("ln -s ~/Projects/stocks/mt5/*.mq* .")

if args.newdata:
    subprocess.call("cp /home/andre/.wine/drive_c/Program\ Files/MetaTrader\ 5/MQL5/Files/* ~/Projects/stocks/data/")

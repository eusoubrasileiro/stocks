//+------------------------------------------------------------------+
//|                                                       Expert.mqh |
//| Modified version by Andre with more public methods               |
//+------------------------------------------------------------------+
...
public:
   ...
   virtual bool      Refresh(void); // refresh indicators and internal data - like quotes in cposition info
...
bool CExpert::SelectPosition(void)
  {
   bool res=false;
   return m_position.SelectByMagic(m_symbol.Name(), m_magic);
  }
//+------------------------------------------------------------------+
//| Main function                                                    |
//+------------------------------------------------------------------+
